require([
 ...
 const HoobbiesPopUp = {
  ...
  const HobbiesLayer = new FeatureLayer({
    ...
    outFields:["Name"],
    popupTemplate: HoobbiesPopUp
  });

  //Hiking (points)
  const HikingLayer = new FeatureLayer({
    url: "https://services.arcgis.com/w9dBo4CVIrugrGos/arcgis/rest/services/hiking_locations/FeatureServer/0",
    outFields:["Name"],
    popupTemplate: HoobbiesPopUp
  });
  ...
  const map = new Map({
    basemap: basemap,
    layers: [HobbiesLayer,HikingLayer]
